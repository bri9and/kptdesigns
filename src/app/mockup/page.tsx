...
const catalog: Category[] = [
  ...
  },
  {
    ...
    concepts: [
      ...
      {
        slug: "v51-galaxy-brain",
        name: "V51 — Galaxy Brain",
        emoji: "🧠",
        descriptor: "Neuron-and-galaxy hybrid hero, dendrite traces over star fields, dark cosmic ground with ember accents.",
        risk: "High Risk",
        appeal: "Epic",
      },
      {
  ...
  },
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        name: "V34 — Grid North",
        emoji: "🧭",
        descriptor: "Survey-plat composition, bearing arrows, monument markers, north-arrow nav.",
        risk: "Low Risk",
        appeal: "Restrained",
      },
      {
  ...
  },
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        name: "V58 — Group Text",
        emoji: "💬",
        descriptor: "Mock SMS thread interface — GC dispatches, sub replies, photo attachments inline as portfolio.",
        risk: "High Risk",
        appeal: "Novel",
      },
    ],
  ...
  {
    id: "naturalist",
    title: "Naturalist / Organic",
    blurb: "Field-journal weight. Pressed specimens, end-grain rings, hardiness zones, kernmantle rope, bench-shop walnut. Living-trade vocabulary, scholarly register.",
    concepts: [
      {
        slug: "v28-herbarium",
        name: "V28 — Herbarium",
  ...
  },
  {
    ...
    blurb: "Honest mass. Cold-rolled plate, weld seams, hammer-strike dents, tarpaper substrate. Trade brands as hot iron and exposed structure.",
    concepts: [
      {
        slug: "v27-rivetwork",
        name: "V27 — Rivetwork",
  ...
  },
  {
    ...
    blurb: "Scroll-as-screenplay. Title-card transitions, freeway-headlight sweeps, bucket-truck POV, sewer-cam HUD. The page reads like a take.",
    concepts: [
      {
      ...
      {
        slug: "v54-sound-stage",
        name: "V54 — Sound Stage",
        emoji: "🎬",
        descriptor: "Title-card transitions, Academy-ratio hero, gaffer-tape accents, slate-clap section dividers.",
        risk: "Medium Risk",
        appeal: "Bold",
      },
      {
  ...
  },
  {
    id: "playful",
    title: "Playful / Toy",
    blurb: "Sticker-pack energy, kinetic type, hardware-store color decks, peg-board outlines, fridge-magnet checklists. Loud where the rest of the catalog is sober.",
    concepts: [
      {
        slug: "v24-paint-chip",
        name: "V24 — Paint Chip",
  ...
  },
  {
    id: "civic",
    title: "Civic / Signage",
    blurb: "Regulated public-signage vocabulary — Highway Gothic, ANSI Z535, jurisdictional palettes, GIS hatching. The grammar of permits, plats, and parking lots.",
    concepts: [
      {
      ...
      {
        slug: "v50-trader-tarp",
        name: "V50 — Trader Tarp",
        emoji: "🚧",
        descriptor: "Yellow corrugated \"FRESH OIL\" sign as the type system; site composed as folded site-protection signage.",
        risk: "High Risk",
        appeal: "Edgy",
      },
      {
