...
const catalog: Category[] = [
  ...
  },
  {
    ...
    concepts: [
      ...
      {
        slug: "v74-liquid-glass",
        name: "V74 — Liquid Glass",
        emoji: "🪞",
        descriptor: "Dark editorial agency landing — Instrument Serif italic, hairline-bordered glass nav, white-pill CTAs, partner names rendered as serif-italic display text.",
        risk: "Medium Risk",
        appeal: "Premium",
      },
      {
        slug: "v75-aethera",
        name: "V75 — Aethera Studio",
        emoji: "🌅",
        descriptor: "White stage with serif italic accents over a 300px-from-top looping video, manual rAF fade-in/out cycle, monochrome refinement.",
        risk: "Low Risk",
        appeal: "Restrained",
      },
      {
        ...
        name: "V76 — Dot",
        emoji: "📟",
        descriptor: "Cream backdrop, floating glass nav pill, Nokia-screen typing animation overlaid on a phone in the bg. Calm + retro.",
        risk: "Medium Risk",
        appeal: "Novel",
      },
      {
        ...
        name: "V77 — Lumina",
        emoji: "🌫️",
        descriptor: "Immersive video bg with a stylized liquid-glass footer carrying logo, link columns, and social row. Sci-fi minimal.",
        risk: "Medium Risk",
        appeal: "Premium",
      },
      {
        ...
        name: "V78 — Celestia",
        emoji: "🌌",
        descriptor: "Cinematic dark hero, no chrome — just looping video, vignette, serif tagline (\"Built once. Evolved forever.\") and two pill CTAs.",
        risk: "Low Risk",
        appeal: "Premium",
      },
      {
        ...
        name: "V79 — Clay",
        emoji: "🧱",
        descriptor: "3D-creator portfolio: massive Kanit gradient text, centered claymorphic portrait, white pill contact CTA. Playful + premium.",
        risk: "High Risk",
        appeal: "Bold",
      },
      {
        ...
        name: "V80 — Glassmorph",
        emoji: "💜",
        descriptor: "Pure black canvas with purple/pink ambient blob, gradient-fill display headline, glass announcement pill, infinite logo marquee.",
        risk: "Medium Risk",
        appeal: "Bold",
      },
      {
        ...
        name: "V81 — New Era",
        emoji: "📐",
        descriptor: "Brutalist Rubik display: \"NEW ERA / OF SITES / STARTS NOW\" stacked on dark blue with looping video bg + custom SVG-shape CTA.",
        risk: "High Risk",
        appeal: "Bold",
      },
      {
        ...
        name: "V82 — Mindloop",
        emoji: "🔁",
        descriptor: "Pure monochrome editorial. Hero with avatars + email pill, then a \"Search has changed.\" section explaining ChatGPT/Perplexity/Google AI rules.",
        risk: "Medium Risk",
        appeal: "Restrained",
      },
      {
        slug: "v83-aetheris",
        name: "V83 — Aetheris Voyage",
        emoji: "🚀",
        descriptor: "Space-travel cinematic hero, manual JS crossfade on the bg loop, paired liquid-glass stat cards, italic display tagline. Premium x novel.",
        risk: "High Risk",
        appeal: "Epic",
      },
      {
