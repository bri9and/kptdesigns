...
const catalog: Category[] = [
  ...
  // ─── NEW: Brand Studies / Reference ────────────────────────────────────
  // 49 hand-built brand-themed mockups served as static HTML from
  // /public/concepts/. These cards open the full HTML page in a new tab
  // (external = true). Sourced from /public/concepts/*.html that were not
  // already represented in the brandConcepts buckets below.
  {
    id: "brand-studies",
    title: "Brand Studies / Reference",
    blurb: "Reference brand studies — direction explorations sourced from the design canon.",
    concepts: [
      {
        slug: "airbnb",
        name: "Airbnb",
